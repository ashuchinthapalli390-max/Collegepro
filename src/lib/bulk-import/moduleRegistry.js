...
export const BULK_IMPORT_MODULE_REGISTRY = {
  ...
  bos_meetings: {
    ...
    category: 'academic_governance',
    description: 'Departmental syllabus revisions, curriculum regulations, committee members, agenda, resolutions, and meeting minutes.',
    version: 'v2',
    destinationPermission: 'bos.create',
    destinationStoreKey: 'BOS',
    defaultWorkflowStatus: 'DRAFT',
    primaryRecordField: 'meeting_title',
    columns: [
      { key: 'meeting_source_key', label: 'Meeting Key / Reference', required: false, type: 'string', example: 'BOS-CYS-R23-01' },
      { key: 'department_code', label: 'Department Code', required: true, type: 'string', example: 'CYS' },
      { key: 'department_name', label: 'Department Name', required: false, type: 'string', example: 'CSE (Cyber Security)' },
      { key: 'regulation_codes', label: 'Regulation (R20, R23)', required: true, type: 'string', example: 'R23' },
      { key: 'regulation_meeting_number', label: 'Regulation Meeting #', required: false, type: 'number', example: 1 },
      { key: 'academic_year', label: 'Academic Year', required: false, type: 'string', example: '2023-24' },
      { key: 'target_year', label: 'Target Year', required: false, type: 'string', example: 'I Year' },
      { key: 'meeting_title', label: 'Meeting Title', required: true, type: 'string', example: 'R23 - 1st Board of Studies Meeting - I Year' },
      { key: 'meeting_date', label: 'Meeting Date (YYYY-MM-DD)', required: true, type: 'date', example: '2023-09-26' },
      { key: 'meeting_time', label: 'Meeting Time', required: false, type: 'string', example: '10:00' },
      { key: 'meeting_mode', label: 'Meeting Mode', required: false, type: 'string', example: 'ONLINE' },
      { key: 'platform', label: 'Platform / Venue', required: false, type: 'string', example: 'Microsoft Teams' },
      { key: 'private_meeting_link', label: 'Private Meeting Link', required: false, type: 'string', example: 'https://teams.microsoft.com/...' },
      { key: 'circular_reference', label: 'Circular Reference', required: false, type: 'string', example: 'NEC/CSE (CS)/BoS-6' },
      { key: 'circular_date', label: 'Circular Date (YYYY-MM-DD)', required: false, type: 'date', example: '2026-02-17' },
      { key: 'chairperson', label: 'Chairperson / HOD', required: false, type: 'string', example: 'Dr. V. V. A. S. Lakshmi' },
      { key: 'member_count', label: 'Member Count', required: false, type: 'number', example: 11 },
      { key: 'member_list_json', label: 'Member List (JSON)', required: false, type: 'string', example: '[{"name":"Dr. V. V. A. S. Lakshmi","member_type":"CHAIRMAN"}]' },
      { key: 'agenda_items_json', label: 'Agenda Items (JSON)', required: false, type: 'string', example: '["Approval of I Year Syllabus"]' },
      { key: 'resolutions_json', label: 'Resolutions (JSON)', required: false, type: 'string', example: '["Resolved to approve syllabus"]' },
      { key: 'source_files', label: 'Source Files', required: false, type: 'string', example: '01_R23_1st_BoS_CYS_2023-09-26.pdf' },
      { key: 'source_sha256_json', label: 'Source SHA-256 (JSON)', required: false, type: 'string', example: '{"file.pdf":"1d4cc6..."}' },
      { key: 'source_confidence', label: 'Source Confidence', required: false, type: 'string', example: 'HIGH' },
      { key: 'review_notes', label: 'Review Notes', required: false, type: 'string', example: 'Minutes verified.' }
    ],
    duplicateKeys: ['meeting_source_key', 'department_code', 'regulation_codes', 'meeting_date']
  },
